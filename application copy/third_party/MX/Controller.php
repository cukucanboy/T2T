...
//var_dump($class);
	...
	public function setMetaData($title = null, $desc = null, $keywords = null ,$ogimg = null){
        ...
        if(empty($ogimg)){
            //$this->data['metaogimg'] = $this->appSettings[0]->header_logo_img;
            $this->data['metaogimg'] = 'http://'.$this->appSettings[0]->site_url.'/uploads/global/favicon.png';
        }else{
            $this->data['metaogimg'] = $ogimg;
        }
