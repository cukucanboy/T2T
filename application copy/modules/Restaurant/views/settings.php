RESTAURANT<style type="text/css">
  .modal .modal-body {
    max-height: 450px;
    overflow-y: auto;
}
...
<h3 class="margin-top-0">Restaurant Settings</h3>
<form action="" method="POST">
  <div class="panel panel-default">
    <ul class="nav nav-tabs nav-justified" role="tablist">
      <li class="active" id="Generaltab"><a href="#GENERAL" data-toggle="tab">General</a></li>
      <li class=""><a href="#RESTAURANTTYPES" data-toggle="tab">Types</a></li>
    ...
    <div class="panel-body">
      ...
      <div class="tab-content form-horizontal">
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
          ...
          <hr>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Featured Restaurant</label>
            <div class="col-md-2">
          ...
          <div class="clearfix"></div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Listings Restaurant</label>
            <div class="col-md-2">
          ...
          <div class="clearfix"></div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Search Result Restaurant</label>
            <div class="col-md-2">
          ...
          <div class="clearfix"></div>
          <!-- <div class="row form-group">
            <label class="col-md-2 control-label text-left">Popular Restaurant</label>
            <div class="col-md-2">
              <input class="form-control" type="text" placeholder="" name="popular"  value="<?php echo $settings[0]->front_popular;?>">
            </div>
            <label class="col-md-4 control-label text-left">Popuar restaurant are based on best reviews</label>
            <div class="col-md-3">
            </div>
          </div> -->
          <div class="row form-group">
        ...
        <div class="tab-pane wow fadeIn animated in" id="RESTAURANTTYPES">
          <div class="add_button_modal">
            <button type="button" data-toggle="modal" data-target="#ADD_RESTAURANT_TYPES" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Add</button>
          </div>
          <div class="clearfix"></div>
    ...
    <div class="panel-footer">
      ...
      <input name="updatefor" value="restaurant" type="hidden">
...
<!--Add restaurant inclusions types Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="" method="POST" enctype="multipart/form-data" >
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Add Restaurant Inclusion</h4>
        </div>
        <div class="modal-body form-horizontal">
          <div class="row form-group">
...
<!---end add restaurant inclusion modal-->

<!--Add restaurant exclusions Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="" method="POST" enctype="multipart/form-data" >
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Add Restaurant Exclusion</h4>
        </div>
        <div class="modal-body form-horizontal">
          <div class="row form-group">
...
<!---end add restaurant exclusion modal-->

<!--Add restaurant type types Modal -->
<div class="modal fade" id="ADD_RESTAURANT_TYPES" tabindex="-1" role="dialog" aria-labelledby="ADD_RESTAURANT_TYPES" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="" method="POST" enctype="multipart/form-data" >
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Add Restaurant Type</h4>
        </div>
        <div class="modal-body form-horizontal">
          <div class="row form-group">
            <label  class="col-md-3 control-label text-left">Type Name</label>
