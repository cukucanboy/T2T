  ...
  $(function(){
     ...
     $(".submitfrm").click(function(){
...

      {
       ...
       if(submitType == "add"){
       url = "<?php echo base_url();?>admin/activity/add" ;

       }else{
       url = "<?php echo base_url();?>admin/activity/manage/"+slug;

       }

       $.post(url,$(".activity-form").serialize() , function(response){
          if($.trim(response) != "done"){
          $(".output").html(response);
          }else{
             window.location.href = "<?php echo base_url().$adminsegment."/activity/"?>";
          }
      ...
      <div class="tab-content form-horizontal">
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
              ...
              <table class="table table-striped table-bordered" cellspacing="1" bgcolor="#cccccc">
                <tbody>
                  ...
                  <tr bgcolor="#ffffff" style="text-align:center">
                    <td>Quantity</td>
                    <td><input type="text" class="form-control input-sm adult" name="maxadult" <?php echo $adultStatus;?> id="" size="" value="<?php echo @$tdata[0]->activity_max_adults;?>"></td>
                    <td><input type="text" class="form-control input-sm child" name="maxchild" <?php echo $childStatus;?> id="" size="" value="<?php echo @$tdata[0]->activity_max_child;?>"></td>
                    <td><input type="text" class="form-control input-sm infant" name="maxinfant" <?php echo $infantStatus;?> id="" size="" value="<?php echo @$tdata[0]->activity_max_infant;?>"></td>
                  </tr>
                  <tr bgcolor="#ffffff" style="text-align:center">
                    <td>Price</td>
                    <td><input type="text" class="form-control input-sm adult" <?php echo $adultStatus;?> name="adultprice" id="" size="" value="<?php echo @$tdata[0]->activity_adult_price;?>"></td>
                    <td><input type="text" class="form-control input-sm child" <?php echo $childStatus;?> name="childprice" id="" size="" value="<?php echo @$tdata[0]->activity_child_price;?>"></td>
                    <td><input type="text" class="form-control input-sm infant" <?php echo $infantStatus;?> name="infantprice" id="" size="" value="<?php echo @$tdata[0]->activity_infant_price;?>"></td>
                  </tr>
                  <tr bgcolor="#ffffff" style="text-align:center">
                    <td>Enable</td>
                    <td>
          ...
          <?php if($isadmin){ ?>
            ...
            <div class="col-md-2">
              <select  class="form-control" name="activitystars">
            ...
            <?php }else{ ?>
            <input type="hidden" name="activitystars" value="<?php echo @$tdata[0]->activity_stars;?>">
            <?php } ?>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <input type="text"  class="form-control" name="activitydays" value="<?php echo @$tdata[0]->activity_days; ?>">
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <input type="text"  class="form-control" name="activitynights" value="<?php echo @$tdata[0]->activity_nights; ?>">
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
              <select  class="chosen-select" name="activitytype">
          ...
          <div class="panel panel-default">
            ...
            <div class="col-md-6">
              ...
              <input type="hidden" name="locations[]" id="locationid<?php echo $i;?>" required="" value="<?php echo @$activitylocations[$i]->id; ?>">
          ...
          <div class="row form-group" style='<?php if($adminsegment == "supplier"){ echo "display:none;"; } ?>'>
            ...
            <div class="col-md-8">
              <select multiple class="chosen-multi-select" name="relatedactivity[]">
                <?php if(!empty($all_activity)){ $activityrelated = explode(",",$tdata[0]->activity_related);
        ...
        <div class="tab-pane wow fadeIn animated in" id="POLICY">
          <div class="row form-group">
            ...
            <div class="col-md-6">
              <select multiple class="chosen-multi-select" name="activitypayments[]">
                <?php if(!empty($activitypayments)){ $tpayments = explode(",",$tdata[0]->activity_payment_opt); foreach($activitypayments as $tp){ ?>
        ...
        <div class="tab-pane wow fadeIn animated in" id="CONTACT">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
              <input name="activitywebsite" type="text" placeholder="Website" class="form-control " value="<?php echo @$tdata[0]->activity_website;?>" />
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Operator's Phone</label>
            <div class="col-md-4">
              <input name="activityphone" type="text" placeholder="Phone" class="form-control" value="<?php echo @$tdata[0]->activity_phone;?>" />
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Operator's Full Address</label>
            <div class="col-md-6">
              <input name="activityfulladdress" type="text" placeholder="Address" class="form-control" value="<?php echo @$tdata[0]->activity_fulladdress;?>" />
            </div>
          </div>
        </div>
        <div class="tab-pane wow fadeIn animated in" id="TRANSLATE">
          <?php foreach($languages as $lang => $val){ if($lang != "en"){ @$trans = getBackActivityTranslation($lang,$activityid); ?>
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="row form-group">
                <label class="col-md-2 control-label text-left">Activity Name</label>
                <div class="col-md-4">
                  <input name='<?php echo "translated[$lang][title]"; ?>' type="text" placeholder="Activity Name" class="form-control" value="<?php echo @$trans[0]->trans_title;?>" />
                </div>
              </div>
              <div class="row form-group">
                <label class="col-md-2 control-label text-left">Activity Description</label>
