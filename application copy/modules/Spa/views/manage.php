  ...
  $(function(){
     ...
     $(".submitfrm").click(function(){
...

      {
       ...
       if(submitType == "add"){
       url = "<?php echo base_url();?>admin/spa/add" ;

       }else{
       url = "<?php echo base_url();?>admin/spa/manage/"+slug;

       }

       $.post(url,$(".spa-form").serialize() , function(response){
          if($.trim(response) != "done"){
          $(".output").html(response);
          }else{
             window.location.href = "<?php echo base_url().$adminsegment."/spa/"?>";
          }
...
<form class="form-horizontal spa-form" method="POST" action="" enctype="multipart/form-data"  onsubmit="return false;" >
  <div class="panel panel-default">
      ...
      <div class="tab-content form-horizontal">
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
              ...
              <table class="table table-striped table-bordered" cellspacing="1" bgcolor="#cccccc">
                <tbody>
                  ...
                  <tr bgcolor="#ffffff" style="text-align:center">
                    <td>Quantity</td>
                    <td><input type="text" class="form-control input-sm adult" name="maxadult" <?php echo $adultStatus;?> id="" size="" value="<?php echo @$tdata[0]->spa_max_adults;?>"></td>
                    <td><input type="text" class="form-control input-sm child" name="maxchild" <?php echo $childStatus;?> id="" size="" value="<?php echo @$tdata[0]->spa_max_child;?>"></td>
                    <td><input type="text" class="form-control input-sm infant" name="maxinfant" <?php echo $infantStatus;?> id="" size="" value="<?php echo @$tdata[0]->spa_max_infant;?>"></td>
                  </tr>
                  <tr bgcolor="#ffffff" style="text-align:center">
                    <td>Price</td>
                    <td><input type="text" class="form-control input-sm adult" <?php echo $adultStatus;?> name="adultprice" id="" size="" value="<?php echo @$tdata[0]->spa_adult_price;?>"></td>
                    <td><input type="text" class="form-control input-sm child" <?php echo $childStatus;?> name="childprice" id="" size="" value="<?php echo @$tdata[0]->spa_child_price;?>"></td>
                    <td><input type="text" class="form-control input-sm infant" <?php echo $infantStatus;?> name="infantprice" id="" size="" value="<?php echo @$tdata[0]->spa_infant_price;?>"></td>
                  </tr>
                  <tr bgcolor="#ffffff" style="text-align:center">
                    <td>Enable</td>
                    <td>
          ...
          <?php if($isadmin){ ?>
            ...
            <div class="col-md-2">
              <select  class="form-control" name="spatars">
            ...
            <?php }else{ ?>
            <input type="hidden" name="spatars" value="<?php echo @$tdata[0]->spa_stars;?>">
            <?php } ?>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <input type="text"  class="form-control" name="spadays" value="<?php echo @$tdata[0]->spa_days; ?>">
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <input type="text"  class="form-control" name="spanights" value="<?php echo @$tdata[0]->spa_nights; ?>">
            </div>
          </div>


          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Spa Type</label>
            <div class="col-md-4">
              <select  class="chosen-select" name="spatype">
          ...
          <div class="panel panel-default">
            ...
            <div class="col-md-6">
              ...
              <input type="hidden" name="locations[]" id="locationid<?php echo $i;?>" required="" value="<?php echo @$spalocations[$i]->id; ?>">
          ...
          <div class="row form-group" style='<?php if($adminsegment == "supplier"){ echo "display:none;"; } ?>'>
            ...
            <div class="col-md-8">
              <select multiple class="chosen-multi-select" name="relatedspa[]">
                <?php if(!empty($all_spa)){ $sparelated = explode(",",$tdata[0]->spa_related);
          ...
          <div class="row form-group" style='<?php if($adminsegment == "supplier"){ echo "display:none;"; } ?>'>
            ...
            <div class="col-md-8">
              <select multiple class="chosen-multi-select" name="nearbyrelatedspa[]">
                <?php if(!empty($data_relate)){
                  $spanearbyrelated = explode(",",$this->Spa_model->nearbyhtml($tdata[0]->spa_nearby_related));
                  foreach($data_relate as $t):
                    ...
                    $value = $t->id.''.$module ;
                  ?>
                <option value="<?= $value ?>" <?php if(in_array($value,$spanearbyrelated)){echo "selected";} ?>  ><?php echo $t->title;?></option>
                <?php endforeach; } ?>
              </select>
            </div>
          </div>
        ...
        <div class="tab-pane wow fadeIn animated in" id="POLICY">
          <div class="row form-group">
            ...
            <div class="col-md-6">
              <select multiple class="chosen-multi-select" name="spapayments[]">
                <?php if(!empty($spapayments)){ $tpayments = explode(",",$tdata[0]->spa_payment_opt); foreach($spapayments as $tp){ ?>
        ...
        <div class="tab-pane wow fadeIn animated in" id="CONTACT">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
              <input name="spawebsite" type="text" placeholder="Website" class="form-control " value="<?php echo @$tdata[0]->spa_website;?>" />
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Operator's Phone</label>
            <div class="col-md-4">
              <input name="spaphone" type="text" placeholder="Phone" class="form-control" value="<?php echo @$tdata[0]->spa_phone;?>" />
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Operator's Full Address</label>
            <div class="col-md-6">
              <input name="spafulladdress" type="text" placeholder="Address" class="form-control" value="<?php echo @$tdata[0]->spa_fulladdress;?>" />
            </div>
          </div>
        </div>
        <div class="tab-pane wow fadeIn animated in" id="TRANSLATE">
          <?php foreach($languages as $lang => $val){ if($lang != "en"){ @$trans = getBackSpaTranslation($lang,$spaid); ?>
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="row form-group">
                <label class="col-md-2 control-label text-left">Spa Name</label>
                <div class="col-md-4">
                  <input name='<?php echo "translated[$lang][title]"; ?>' type="text" placeholder="Spa Name" class="form-control" value="<?php echo @$trans[0]->trans_title;?>" />
                </div>
              </div>
              <div class="row form-group">
                <label class="col-md-2 control-label text-left">Spa Description</label>
    ...
    <div class="panel-footer">
      <input type="hidden" id="slug" value="<?php echo @$tdata[0]->spa_slug;?>" />
      <input type="hidden" name="submittype" value="<?php echo $submittype;?>" />
      <input type="hidden" name="spaid" value="<?php echo @$spaid;?>" />
