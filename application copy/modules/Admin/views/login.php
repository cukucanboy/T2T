...
<div class="container">
    ...
    <img data-wow-duration="0.5s" data-wow-delay="0.5s" src="<?php echo base_url(); ?>assets/img/admin.png"
         class="wow fadeIn center-block" style="width:78px;height:60px;margin-top:100px;margin-bottom:20px" alt=""/>
    <form method="POST" data-wow-duration="1s" data-wow-delay="1s"
          class="logpanel form-signin form-horizontal wow fadeIn animated" role="form" onsubmit="return false;">
        <div>
        ...
        <button data-wow-duration="2s" data-wow-delay="s" type="submit"
                class="btn-lg btn btn-primary btn-block ladda-button fadeIn animated" data-style="zoom-in">Login
        </button>
    ...
    <?php /*
    <p data-wow-duration="2s" data-wow-delay="2s" class="text-center wow fadeInDown" style="color:#f4f4f4"> Powered by
        <a target="_blank" style="color: #FCFCFC" href="http://phptravels.com"><b>PHPTRAVELS</b></a> <a
                href="http://phptravels.com/change-log/#<?php echo PT_VERSION; ?>"></a><?php echo PT_VERSION; ?></p> */ ?>
</div>
<script>
    // Bind normal buttons
