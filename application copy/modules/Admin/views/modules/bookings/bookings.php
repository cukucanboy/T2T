        ...
        $(".resend").on('click', function () {
            ...
            $.alert.open('confirm', 'Resend Invoice?', function (answer) {
                if (answer == 'yes') {
                    ...
                    $.post("<?php echo base_url();?>admin/bookings/resendinvoice", {
                        id: id,
                        refno: refno
        ...
        <div class="panel-heading">
            ...
            <?php if ($this->uri->segment(1) != "supplier") { ?>
                <div class="pull-right">
                    <button class="btn btn-xs btn-success paid_selected"><i class="fa fa-check-square-o"></i> Paid
                    </button>
                    <button class="btn btn-xs btn-warning unpaid_selected"><i class="fa fa-minus-square"></i> Unpaid
                    </button>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingTwo">
                            <h4 class="panel-title">
                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#filter"
                          ...
                          <?php
                                foreach ($modules as $mod):
                                    ...
                                    if ($ispermitted && $istrue && !$isintegration) {
                                        ?>
                              <option value="<?php echo $mod; ?>" <?php if (@$selmodule == $mod) {
                                            echo "selected";
                                        } ?> ><?php echo ucfirst($mod); ?></option>
                              <?php } endforeach; ?>
                ...
                -->
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input class="dprfrom form-control" type="text" id="invoicefromdate"
                                                   placeholder="Invoice From Date" name="" value="">
                                        </div>
                                        <label class="col-md-2 control-label">Invoice To Date</label>
                                        <div class="col-md-3">
                                            <input class="dprto form-control" type="text" id="invoicetodate"
                                                   placeholder="Invoice To Date" name="" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <div id="ajax-data">
                ...
                <table cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        ...
                        <th><i class="fa fa-list-ol" data-toggle="tooltip" data-placement="top" title="Invoice Number">&nbsp;</i>
                        </th>
                        <th><span class="fa fa-user" data-toggle="tooltip" data-placement="top"
                                  title="Costumer Name"></span> Customer Name
                        </th>
                        <th><span class="fa fa-info-circle" data-toggle="tooltip" data-placement="top"
                                  title="Name of Section or Item"></span> Item
                        </th>
                        <th><span class="fa fa-dollar" data-toggle="tooltip" data-placement="top"
                                  title="Total Amount"></span> Total
                        </th>
                        <th><span class="fa fa-money" data-toggle="tooltip" data-placement="top"
                                  title="Amount to Deposit"></span> Dep
                        </th>
                        <th><i class="fa fa-calendar" data-toggle="tooltip" data-placement="top"
                               title="Created On Date"></i> Date
                        </th>
                        <?php if ($this->uri->segment(1) != "supplier") { ?>
                            <th class="text-center"><i class="fa fa-refresh" data-toggle="tooltip" data-placement="top"
                                                       title="Status of Invoice"></i> Status
                            </th>
                        <?php } ?>
                        <th class="text-center" style="width:280px;"><i class="fa fa-wrench" data-toggle="tooltip"
                                                                        data-placement="top" title="Action"></i> Action
                        </th>
                    </tr>
                    </thead>
                    ...
                    if (!empty($bookings)) {
                        ...
                        foreach ($bookings['all'] as $book) {
                            ...
                            ?>
                            <tr>
                                <td><input type="checkbox" name="booking_ids[]" value="<?php echo $book->booking_id; ?>"
                                           class="selectedId"/></td>
                                    ...
                                    <td>
                                        ...
                                        if ($book->booking_status == "paid") {
                                            ...
                                            <span style="margin-top:5px;"
                                                  class="btn btn-block btn-xs status btn-success"
                                                  data-expiry="<?php echo $book->booking_expiry; ?>"
                                                  id="<?php echo $book->booking_id; ?>">Paid</span>
                                            <?php
                                        } elseif ($book->booking_status == "unpaid") {
                                            ?>
                                            <span style="margin-top:5px;"
                                                  class="btn btn-block btn-xs status btn-warning"
                                                  data-expiry="<?php echo $book->booking_expiry; ?>"
                                                  id="<?php echo $book->booking_id; ?>">Unpaid</span>
                                            <?php
                                        } elseif ($book->booking_status == "cancelled") {
                                            ?>
                                            <span style="margin-top:5px;"
                                                  class="btn btn-block btn-xs status btn-default">Cancelled</span>
                                            <?php
                                        }
                                        ?>
                                    </td>
                                ...
                                <td style="width:330px" align="center">
                                    ...
                                    if ($book->booking_status != "cancelled") {
                                        if ($this->uri->segment(1) != "supplier") { ?>
                                            <span class="btn btn-xs btn-default reqcancel"
                                                  id="<?php echo $book->booking_id; ?>" data-toggle="tooltip"
                                                  data-placement="top" title="Cancel Booking"> Cancel</span>
                                        <?php }
                                        if (pt_permissions($book->booking_type . 'bookings', @$userloggedin)) { ?>   <a
                                                href="<?php echo base_url() . $adminsegment; ?>/bookings/edit/<?php echo $book->booking_type; ?>/<?php echo $book->booking_id; ?>">
                                                <span class="btn btn-xs btn-warning"><i class="fa fa fa-edit"></i> Edit</span>
                                            </a><?php } ?>
                                        <span class="btn btn-xs btn-success resend" title="Resend Invoice"
                                              data-toggle="tooltip" data-placement="top"
                                              data-refno="<?php echo $book->booking_ref_no; ?>"
                                              id="<?php echo $book->booking_id; ?>"><i class="fa fa-envelope"></i> Resend</span>
                                    <?php } ?>
                                    <?php if ($adminsegment != "supplier") { ?>   <span
                                            class="btn btn-xs btn-danger del_single"
                                            id="<?php echo $book->booking_id; ?>"><i
                                                class="fa fa-times"></i> Delete</span> <?php } ?>
                                    <a title="Preview Invoice" data-toggle="tooltip" data-placement="top"
                                       href="<?php echo base_url(); ?>invoice?id=<?php echo $book->booking_id; ?>&sessid=<?php echo $book->booking_ref_no; ?>"
                                       target="_blank"><span class="btn btn-xs btn-primary"><i
                                                    class="fa fa-search-plus"></i> Invoice</span> </a>
                                </td>
                            </tr>
                        <?php }
                    } ?>
