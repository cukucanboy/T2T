    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".couponsubmit").on('click', function () {
                ...
                $.post("<?php echo base_url();?>invoice/validate_coupon", {
                    code: code,
                    bookingid: bookingid
                }, function (resp) {
                    if ($.trim(resp) > 0) {
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="col-md-6">
                <div class="panel panel-default" style="height:150px">
                    ...
                    <div class="panel-body">
                        <p><strong><?php echo $invoice[0]->ai_first_name . " " . $invoice[0]->ai_last_name; ?></strong>
                        </p>
            ...
            <div class="col-md-4">
                ...
                <strong><?php echo trans('07'); ?>
                    : </strong> <?php echo date("M j, Y", strtotime($invoice[0]->book_checkin)); ?>
                <br> <strong><?php echo trans('09'); ?>
                    : </strong> <?php echo date("M j, Y", strtotime($invoice[0]->book_checkout)); ?>
            </div>

            <div class="col-md-5">
                <p><strong><?php echo $invoice[0]->book_hotel; ?></strong></p>
                <strong><?php echo trans('098'); ?>
                    : </strong> <?php echo $response->hotelAddress . ", " . $response->hotelCity; ?>
            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <strong><?php echo trans('0121'); ?></strong> <?php if (!empty($invoice[0]->booking_coupon)) {
                                        echo "<span class='btn btn-success btn-xs pull-right'>" . $invoice[0]->booking_coupon_rate . "% Coupon Discount Applied</span>";
                                    } ?></h3>
                            </div>
                            <div class="panel-body">
                                    ...
                                    <table class="table table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <strong><?php echo trans('070'); ?><?php echo trans('0245'); ?></strong>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="thick-line text-right">
                                                <strong><?php echo $invoice[0]->book_roomtotal; ?></strong></td>
                                        </tr>
                ...
                <div class="panel panel-default">
                  <div class="well-sm text-center">
                    <i><span class="fa fa-info-circle"></span> <?php echo trans('0127'); ?> </i>
                        ...
                        <p><strong> <?php echo trans('0149'); ?> </strong>
                            : <?php echo $response->cancellationPolicy; ?></p>
                        <p><strong><?php echo trans('0548'); ?></strong></p>
                        <p><?php echo trans('0129'); ?> : <a
                                    href="<?php echo base_url(); ?>"><?php echo base_url(); ?></a><br>
                ...
                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>checkout" method="POST">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="firstName" id="card-holder-firstname"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="lastName" id="card-holder-lastname"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="cardno" id="card-number" pattern=".{12,}"
                                       required title="12 characters minimum" placeholder="Debit/Credit Card Number"
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-9">
                                ...
                                <input type="hidden" name="paymethod"
                                       value="<?php echo $invoice[0]->booking_payment_type; ?>"/>
                                <input type="hidden" name="bookingid" id="bookingid"
                                       value="<?php echo $invoice[0]->booking_id; ?>"/>
                                <button type="submit" class="btn btn-success btn-lg paynowbtn"
                                        onclick="return expcheck();">Pay Nows
                                </button>
                            </div>
                        </div>
                    </fieldset>
