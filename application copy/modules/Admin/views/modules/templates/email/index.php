...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table class="table table-hover table-striped table-bordered">
            <thead>
            <tr role="row">
                <th class="width25"><i class="fa fa-list-ol" data-toggle="tooltip" data-placement="top" title="Number">&nbsp;</i>
                </th>
                <th>Template Name</th>
            ...
            foreach ($templates as $temp) {
                ...
                if ($foundAdmin !== false) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url(); ?>admin/templates/email/<?php echo $temp->temp_name; ?>"><?php echo $temp->temp_title; ?></a>
                        </td>
                        <td align="center">
                            <a href="<?php echo base_url(); ?>admin/templates/email/<?php echo $temp->temp_name; ?>"><?php echo PT_EDIT; ?></a>
                            <span id="<?php echo $temp->temp_name; ?>" class="btn btn-xs btn-primary sendtotest"><i
                                        class="fa fa-envelope"></i> Email Test</span>
