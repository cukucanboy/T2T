  ...
  <div class="panel-body">
    <div class="panel-body">
     ...
     <?php if(@$profile[0]->accounts_verified == '0'){ ?>
      ...
      if($type == "supplier"){ if(@$chkingadvertising){ ?>

       <div class="col-md-12">
         <div class="form-group ">
           <label class="required">Assign Advertisings</label>
           <select class="chosen-multi-select" name="advertising[]" id="" multiple>
             <?php foreach($advertising as $advertising){ ?>
             <option value="<?php echo $advertising->advertising_id;?>" <?php if(in_array($advertising->advertising_id,@$useradvertising)){ echo "selected"; } ?> ><?php echo $advertising->advertising_title;?></option>
             <?php } ?>
           </select>
         </div>
       </div>
