        ...
        <div>
            ...
            <span>
              ...
              <small class="pull-right wow fadeInRight animated">
                <script> var tD = new Date();
                    var datestr = tD.getDate();
                    document.write("" + datestr + ""); </script> <script type="text/javascript"> var d = new Date();
                      var weekday = new Array("", "", "", "", "", "", "");
                      var monthname = new Array("January", "February", "March", "April", "May", "June", "July", "August", "September", "Octobar", "November", "December");
                      document.write(monthname[d.getMonth()] + " "); </script>
                <script> var tD = new Date();
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="0" class="dropdown-toggle"><i
                                class="fa fa-caret-down fa-lg"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <a href="<?php echo base_url() . $this->uri->segment(1); ?>/profile/"><i
                                        class="glyphicon glyphicon-user"></i>&nbsp;My Profile</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url() . $this->uri->segment(1); ?>/logout"><i
                                        class="fa fa-sign-out"></i>&nbsp;Log Out</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="//phptravels.org/submitticket.php?step=2&deptid=1" target="_blank"><i
                                        class="fa fa-info"></i>&nbsp;Help</a>
                        </li>
                    </ul>
                </li>
                <!-- END EXTRA DROPDOWN-->
