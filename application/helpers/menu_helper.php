    ...
    function child_info($child, $icons, $lang_set)
    {
        ...
        if ($child->content_special == '1') {
            ...
            if (!empty($childexternal)) {
                ...
                $result['childtarget'] = "_" . $child->page_target;
            } else {
                $result['childtarget'] = "";
                $result['hrefchild'] = base_url() . $child->page_slug;
            }
                    ...
                    foreach ($pinfo as $pagesinfo) {
                        ...
                        if ($pagesinfo->content_special == '1') {
                            ...
                            if (!empty($externalink)) {
                                ...
                                $target = "_" . $pagesinfo->page_target;
                            } else {
                                $target = "";
                                $hreflink = base_url() . $pagesinfo->page_slug;
                            }
                        ...
                        ?>
                        <li>
                            <a href="<?php echo $hreflink; ?>" class="<?php pt_active_link($pagesinfo->page_slug); ?>"
                               target="<?php echo $target; ?>"><i
                                        class='<?php echo $icons; ?>'></i><strong><?php echo $pagetitle; ?></strong>
                            </a>
                                        ...
                                        foreach ($children as $child) {
                                            ...
                                            if ($child->content_special == '1') {
                                                ...
                                                if (!empty($childexternal)) {
                                                    ...
                                                    $childtarget = "_" . $child->page_target;
                                                } else {
                                                    $childtarget = "";
                                                    $hrefchild = base_url() . $child->page_slug;
                                                }
                                            ...
                                            <li style="min-width:200px">
                                                <a href="<?php echo $hrefchild; ?>"
                                                   target="<?php echo $childtarget; ?>"><i
                                                            class='<?php echo $icons; ?>'></i> <?php echo $childtitle; ?>
                                                </a>
                                            </li>
                                        <?php }
                                    } ?>
                        ...
                        <nav>
                            ...
                            foreach ($menuitems as $fhi) {
                                ...
                                foreach ($pagesinfo as $pageinfo) {
                                    ...
                                    ?>
                                    <i class="<?php echo $first; ?>"><a href="<?php echo $href6; ?>"
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        target="<?php echo $target; ?>"
                                                                        title="<?php echo $fhtitle; ?>"><?php echo $fhtitle; ?></a></i>
                                <?php }
                            } ?>
                        </nav>
                    </div>
