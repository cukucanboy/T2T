...
//Entertainment
            if (pt_main_module_available('entertainment')) {
                $activeModules[] = "entertainment";
                $this->load->library('Entertainment/Entertainment_lib');
                $this->data['entertainmentlib'] = $this->Entertainment_lib;
                $this->data['locationsList'] = $this->Entertainment_lib->getLocationsList();
                $this->data['featuredEntertainment'] = $this->Entertainment_lib->getFeaturedEntertainment();
                $this->data['popularEntertainment'] = $this->Entertainment_lib->getTopRatedEntertainment();
                ...
                $this->data['featuredSection']['modules']["entertainment"] = (object)array("featured" => $this->Entertainment_lib->getFeaturedEntertainment(), 'moduleTitle' => trans('Entertainment'), 'bgImg' => 'featured-entertainment.jpg', 'booknowClass' => 'warning', 'featuredText' => trans('0451'), 'featuredPrice' => 200, 'currCode' => 'USD');
                $this->data['entertainmentLocations'] = $this->Entertainment_lib->entertainmentByLocations();
                $this->load->helper("Entertainment/entertainment_front");
