...
<h3 class="margin-top-0">Advertising Settings</h3>
<form action="" method="POST">
  <div class="panel panel-default">
    <ul class="nav nav-tabs nav-justified" role="tablist">
      <li class="active" id="Generaltab"><a href="#GENERAL" data-toggle="tab">General</a></li>
      <li class=""><a href="#ADVERTISINGTYPES" data-toggle="tab">Types</a></li>
    ...
    <div class="panel-body">
      ...
      <div class="tab-content form-horizontal">
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
          ...
          <hr>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Featured Advertising</label>
            <div class="col-md-2">
          ...
          <div class="clearfix"></div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Listings Advertising</label>
            <div class="col-md-2">
          ...
          <div class="clearfix"></div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Search Result Advertising</label>
            <div class="col-md-2">
          ...
          <div class="row form-group">
            <label  class="col-md-2 control-label text-left">Related Advertising</label>
            <div class="col-md-2">
        ...
        <div class="tab-pane wow fadeIn animated in" id="ADVERTISINGTYPES">
          <div class="add_button_modal">
            <button type="button" data-toggle="modal" data-target="#ADD_ADVERTISING_TYPES" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Add</button>
          </div>
          <div class="clearfix"></div>
    ...
    <div class="panel-footer">
      ...
      <input name="updatefor" value="advertising" type="hidden">
...
<!--Add advertising inclusions types Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="" method="POST" enctype="multipart/form-data" >
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Add Advertising Inclusion</h4>
        </div>
        <div class="modal-body form-horizontal">
          <div class="row form-group">
...
<!---end add advertising inclusion modal-->

<!--Add advertising exclusions Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="" method="POST" enctype="multipart/form-data" >
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Add Advertising Exclusion</h4>
        </div>
        <div class="modal-body form-horizontal">
          <div class="row form-group">
...
<!---end add advertising exclusion modal-->

<!--Add advertising type types Modal -->
<div class="modal fade" id="ADD_ADVERTISING_TYPES" tabindex="-1" role="dialog" aria-labelledby="ADD_ADVERTISING_TYPES" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="" method="POST" enctype="multipart/form-data" >
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Add Advertising Type</h4>
        </div>
        <div class="modal-body form-horizontal">
          <div class="row form-group">
            <label  class="col-md-3 control-label text-left">Type Name</label>
...
<!---end add advertising type modal-->
