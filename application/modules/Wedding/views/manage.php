  ...
  $(function(){
     ...
     $(".submitfrm").click(function(){
...

      {
       ...
       if(submitType == "add"){
       url = "<?php echo base_url();?>admin/wedding/add" ;

       }else{
       url = "<?php echo base_url();?>admin/wedding/manage/"+slug;

       }

       $.post(url,$(".wedding-form").serialize() , function(response){
          if($.trim(response) != "done"){
          $(".output").html(response);
          }else{
             window.location.href = "<?php echo base_url().$adminsegment."/wedding/"?>";
          }
...
<form class="form-horizontal wedding-form" method="POST" action="" enctype="multipart/form-data"  onsubmit="return false;" >
  <div class="panel panel-default">
      ...
      <div class="tab-content form-horizontal">
        <div class="tab-pane wow fadeIn animated active in" id="GENERAL">
              ...
              <table class="table table-striped table-bordered" cellspacing="1" bgcolor="#cccccc">
                <tbody>
                  ...
                  <tr bgcolor="#ffffff" style="text-align:center">
                    <td>Quantity</td>
                    <td><input type="text" class="form-control input-sm adult" name="maxadult" <?php echo $adultStatus;?> id="" size="" value="<?php echo @$tdata[0]->wedding_max_adults;?>"></td>
                    <td><input type="text" class="form-control input-sm child" name="maxchild" <?php echo $childStatus;?> id="" size="" value="<?php echo @$tdata[0]->wedding_max_child;?>"></td>
                    <td><input type="text" class="form-control input-sm infant" name="maxinfant" <?php echo $infantStatus;?> id="" size="" value="<?php echo @$tdata[0]->wedding_max_infant;?>"></td>
                  </tr>
                  <tr bgcolor="#ffffff" style="text-align:center">
                    <td>Price</td>
                    <td><input type="text" class="form-control input-sm adult" <?php echo $adultStatus;?> name="adultprice" id="" size="" value="<?php echo @$tdata[0]->wedding_adult_price;?>"></td>
                    <td><input type="text" class="form-control input-sm child" <?php echo $childStatus;?> name="childprice" id="" size="" value="<?php echo @$tdata[0]->wedding_child_price;?>"></td>
                    <td><input type="text" class="form-control input-sm infant" <?php echo $infantStatus;?> name="infantprice" id="" size="" value="<?php echo @$tdata[0]->wedding_infant_price;?>"></td>
                  </tr>
                  <tr bgcolor="#ffffff" style="text-align:center">
                    <td>Enable</td>
                    <td>
          ...
          <?php if($isadmin){ ?>
            ...
            <div class="col-md-2">
              <select  class="form-control" name="weddingtars">
            ...
            <?php }else{ ?>
            <input type="hidden" name="weddingtars" value="<?php echo @$tdata[0]->wedding_stars;?>">
            <?php } ?>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <input type="text"  class="form-control" name="weddingdays" value="<?php echo @$tdata[0]->wedding_days; ?>">
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
              <input type="text"  class="form-control" name="weddingnights" value="<?php echo @$tdata[0]->wedding_nights; ?>">
            </div>
          </div>


          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Wedding Type</label>
            <div class="col-md-4">
              <select  class="chosen-select" name="weddingtype">
          ...
          <div class="panel panel-default">
            ...
            <?php  for($i=1; $i<=10; $i++) { $locationName =  $weddinglocations[$i]->name; ?>

            <label class="col-md-2 control-label text-left">Location <?php echo $i; ?></label>
            <div class="col-md-6">

              <input type="text" id="locationlist<?php echo $i; ?>">
              <input type="hidden" name="locations[]" id="locationid<?php echo $i;?>" required="" value="<?php echo @$weddinglocations[$i]->id; ?>">
          ...
          <div class="row form-group" style='<?php if($adminsegment == "supplier"){ echo "display:none;"; } ?>'>
            ...
            <div class="col-md-8">
              <select multiple class="chosen-multi-select" name="relatedwedding[]">
                <?php if(!empty($all_wedding)){ $weddingrelated = explode(",",$tdata[0]->wedding_related);
          ...
          <div class="row form-group" style='<?php if($adminsegment == "supplier"){ echo "display:none;"; } ?>'>
            ...
            <div class="col-md-8">
              <select multiple class="chosen-multi-select" name="nearbyrelatedwedding[]">
                <?php if(!empty($data_relate)){
                  $weddingnearbyrelated = explode(",",$this->Wedding_model->nearbyhtml($tdata[0]->wedding_nearby_related));
                  foreach($data_relate as $t):
                    ...
                    $value = $t->id.''.$module ;
                  ?>
                <option value="<?= $value ?>" <?php if(in_array($value,$weddingnearbyrelated)){echo "selected";} ?>  ><?php echo $t->title;?></option>
                <?php endforeach; } ?>
              </select>
            </div>
          </div>
        ...
        <div class="tab-pane wow fadeIn animated in" id="POLICY">
          <div class="row form-group">
            ...
            <div class="col-md-6">
              <select multiple class="chosen-multi-select" name="weddingpayments[]">
                <?php if(!empty($weddingpayments)){ $tpayments = explode(",",$tdata[0]->wedding_payment_opt); foreach($weddingpayments as $tp){ ?>
        ...
        <div class="tab-pane wow fadeIn animated in" id="CONTACT">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
              <input name="weddingwebsite" type="text" placeholder="Website" class="form-control " value="<?php echo @$tdata[0]->wedding_website;?>" />
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Operator's Phone</label>
            <div class="col-md-4">
              <input name="weddingphone" type="text" placeholder="Phone" class="form-control" value="<?php echo @$tdata[0]->wedding_phone;?>" />
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-2 control-label text-left">Operator's Full Address</label>
            <div class="col-md-6">
              <input name="weddingfulladdress" type="text" placeholder="Address" class="form-control" value="<?php echo @$tdata[0]->wedding_fulladdress;?>" />
            </div>
          </div>
        </div>
        <div class="tab-pane wow fadeIn animated in" id="TRANSLATE">
          <?php foreach($languages as $lang => $val){ if($lang != "en"){ @$trans = getBackWeddingTranslation($lang,$weddingid); ?>
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="row form-group">
                <label class="col-md-2 control-label text-left">Wedding Name</label>
                <div class="col-md-4">
                  <input name='<?php echo "translated[$lang][title]"; ?>' type="text" placeholder="Wedding Name" class="form-control" value="<?php echo @$trans[0]->trans_title;?>" />
                </div>
              </div>
              <div class="row form-group">
                <label class="col-md-2 control-label text-left">Wedding Description</label>
    ...
    <div class="panel-footer">
      <input type="hidden" id="slug" value="<?php echo @$tdata[0]->wedding_slug;?>" />
      <input type="hidden" name="submittype" value="<?php echo $submittype;?>" />
      <input type="hidden" name="weddingid" value="<?php echo @$weddingid;?>" />
