...
// add wedding data
        ...
        $nearbydata = $this->input->post('nearbyrelatedwedding');
        if(!empty($nearbydata)){
          $checknearby = $this->convert_json(@ implode(",", $nearbydata));
          $nearbyrelatedwedding = $checknearby;
        }else{
          $nearbyrelatedwedding = '';
        }
          ...
          'wedding_nearby_related' => $nearbyrelatedwedding,
...
// update wedding data
        ...
        if(!empty($nearbydata)){
          ...
          $nearbyrelatedwedding = $this->convert_json($nearbytmp);
        }else{
          $nearbyrelatedwedding = '';
        }
