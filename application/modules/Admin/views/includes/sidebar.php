        ...
        <div class="menu">
            <div class="menu-content">
                            ...
                            if ($isSuperAdmin) { ?>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/updates/"><i class="fa fa-refresh"></i>
                                        <span>Updates</span><span class="pull-right label label-danger"
                                                                  id="updatescount"><?php if ($chkupdates->count > 0) {
                ...
                <a href="<?php echo base_url(); ?>admin/settings/api/"><?php echo trans('036'); ?></a>
                        ...
                        <!-- END ELEMENT MENU-->
                        <li>
                            <a data-toggle="collapse" data-parent="#social-sidebar-menu" href="#ACCOUNTS"><i
                            ...
                            <ul id="<?php echo trans('017'); ?>" class="collapse wow fadeIn animated">
                                ...
                                <?php } ?>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/accounts/suppliers/"><?php echo trans('023'); ?></a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/accounts/customers/"><?php echo trans('025'); ?></a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/accounts/guest/"><?php echo trans('027'); ?><?php echo trans('025'); ?></a>
                                </li>
                            </ul>
                        </li>
                        <!-- BEGIN ELEMENT MENU-->
                            ...
                            if ($isenabled) {
                                ...
                                if (pt_permissions($modl['Name'], @$userloggedin)) {
                                    if ($modl['isIntegration'] != "Yes") {
                                        ?>
                                        <li>
                                            <a href="#<?php echo $modl['DisplayName']; ?>" data-toggle="collapse"
                                               data-parent="#social-sidebar-menu">
                                                <?php echo $modl['Icon']; ?>
                                                <span><?php echo $modl['DisplayName']; ?></span>
                                                <i class="fa arrow"></i>
                                            </a>
                                            <ul id="<?php echo $modl['DisplayName']; ?>"
                                                class="collapse  wow fadeIn animated">
                        ...
                        if (pt_is_module_enabled('offers')) { ?>
                            <li>
                                ...
                                <ul id="SPECIAL_OFFERS" class="collapse  wow fadeIn animated">
                                    <li>
                                        <a href="<?php echo base_url(); ?>admin/offers/"><?php echo trans('029'); ?><?php echo trans('030'); ?></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>admin/offers/settings/"><?php echo trans('030'); ?><?php echo trans('04'); ?></a>
                                    </li>
                                </ul>
                            </li>
                        <?php }
                    ...
                    <?php if (pt_permissions('locations', @$userloggedin)) { ?>
                        <li>
                            <a href="<?php echo base_url() . $this->uri->segment(1); ?>/locations"><i
                            ...
                            <?php if (pt_permissions('newsletter', @$userloggedin)) { ?>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/newsletter/"><i class="fa fa-envelope"></i>
                                        <span><?php echo trans('031'); ?></span><span
                                                class="pull-right label label-danger" id=""></span>
                                    </a>
                                </li>
                            <?php }
                        }
                    ...
                    <?php if (pt_permissions('booking', @$userloggedin)) { ?>
                        <li>
                            <a href="<?php echo base_url() . $this->uri->segment(1); ?>/bookings/"><i
                                        class="fa fa-list"></i>
                                <span><?php echo trans('034'); ?></span><span class="pull-right label label-danger"
                                                                              id=""></span>
                            </a>
                        </li>
                    <?php } ?>
                    <?php if ($isSuperAdmin) { ?>
                        <li>
                            <a href="#pay-sub-menu" data-toggle="collapse" data-parent="#social-sidebar-menu">
                                <!-- icon--><i class="fa fa-money"></i>
                                <span><?php echo trans('0120'); ?></span>
                                <!-- arrow--><i class="fa arrow"></i>
                            </a>
                            <!-- BEGIN SUB-ELEMENT MENU-->
                            <ul id="pay-sub-menu" class="collapse wow fadeIn animated">
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/payments/">Transaction</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/payments/paymentlog">Payment Log</a>
                                </li>
                            </ul>
                            <!-- END SUB-ELEMENT MENU-->
                        </li>
