    ...
    function updateOrder(order, id, olderval) {
        ...
        if (order != olderval) {
            ...
            if (order > maximumorder || order < 1) {
                ...
                $.post("<?php echo base_url();?>admin/ajaxcalls/update_slide_order", {
                    order: order,
                    id: id
    ...
    <div class="panel panel-primary table-bg">
        ...
        <div class="panel-body">
            <table cellpadding="0" cellspacing="0" border="0"
                ...
                <thead>
                <tr>
                    <th><i class="fa fa-list-ol" data-toggle="tooltip" data-placement="top" title="Number">&nbsp;</i>
                    </th>
                    <th style="width:50px;"><input class="pointer" type="checkbox" data-toggle="tooltip"
                                                   data-placement="top" title="Select All" id="select_all"/></th>
                    <th><span class="fa fa-picture-o" data-toggle="tooltip" data-placement="top" title="Image"></span>
                    </th>
                    <th><span class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Titile"></span>
                        Title
                    </th>
                    <th><span class="fa fa-tasks" data-toggle="tooltip" data-placement="top" title="Position"></span>
                        Position
                    </th>
                    <th><i class="fa fa-tasks" data-toggle="tooltip" data-placement="top" title="Order By"></i> Order
                    </th>
                    <th><i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="Status">&nbsp;</i>
                    </th>
                    <th><i class="fa fa-wrench" data-toggle="tooltip" data-placement="top" title="Action"></i> Action
                    </th>
                </tr>
                </thead>
                <tbody>
                ...
                foreach ($all_slides['all'] as $als) {
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="slide_ids[]" value="<?php echo $als->slide_id; ?>"
                                   class="selectedId"/></td>
                        ...
                        <td>
                            <input class="form-control" type="number" id="order_<?php echo $als->slide_id; ?>"
                                   value="<?php echo $als->slide_order; ?>" min="1" max="<?php echo $max; ?>"
                                   onblur="updateOrder($(this).val(),<?php echo $als->slide_id; ?>,<?php echo $als->slide_order; ?>);"/>
                        </td>
                        <td>
                            <?php if ($als->slide_status == 'Yes') {
                                ?>
                                <span class="check"><i class="fa fa-check" data-toggle="tooltip" data-placement="top"
                                                       title="Enabled"></i></span>
                                <?php
                            } else {
                                ?>
                                <span class="times"><i class="fa fa-times" data-toggle="tooltip" data-placement="top"
                                                       title="Disabled"></i></span>
                                <?php
                            }
                        ...
                        <td align="center">
                            <button data-toggle="modal" href="#editslide_<?php echo $als->slide_id; ?>"
                                    class="btn btn-xs btn-warning" name="<?php echo $als->slide_id; ?>"><i
                                        class="fa fa-external-link"></i> edit
                            </button>
                            <span class="btn btn-xs btn-danger del_single" id="<?php echo $als->slide_id; ?>"><i
                                        class="fa fa-times"></i> delete</span>
                            <a href="<?php echo base_url(); ?>admin/settings/sliders/translate/<?php echo $als->slide_id; ?>"><span
                                        class="btn btn-xs btn-enable"><i
                                            class="fa fa-flag-checkered"></i> Translate</span></a>
                ...
                <form class="form-horizontal my-form" action="" method="POST" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Show Is Day</label>
                            <div class="col-md-4">
                                <select data-placeholder="Enable" class="form-control" name="show_day">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" placeholder="Slide Title Text"
                                       name="slide_title">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" placeholder="Slide Description Text"
                                       name="slide_desc">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" placeholder="Optional Stars Slider"
                                       name="slide_optional">
                            </div>
                        </div>
                        <div class="minislider">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" placeholder="Slide Button Text"
                                           name="slide_button">
                                </div>
                            </div>
                        </div>
                        <hr class="soften">
                        <div class="form-group">
                            <p class="mainres"><label class="col-md-8 control-label">Best Resolution 1024 x 500 </label>
                            </p>
                            <p class="minires"><label class="col-md-8 control-label">Best Resolution 400 x 400 </label>
                            </p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <p class="help-block">
                                    <img src="<?php echo PT_DEFAULT_IMAGE . "slider.png"; ?>"
                                         class="img-rounded preview_img" width="300" height="100" alt=""/>
                                </p>
                            </div>
                        </div>
                    </fieldset>
            ...
            <div class="modal-content">
                    ...
                    <form class="form-horizontal my-form" action="" method="POST" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select data-placeholder="Enable" class="form-control" name="show_day">
                                        <option value="1" <?php if ($allslides->slide_status == "1") {
                                            echo "selected";
                                        } ?>>Monday
                                        </option>
                                        <option value="2" <?php if ($allslides->slide_status == "2") {
                                            echo "selected";
                                        } ?>>Tuesday
                                        </option>
                                        <option value="3" <?php if ($allslides->slide_status == "3") {
                                            echo "selected";
                                        } ?>>Wednesday
                                        </option>
                                        <option value="4" <?php if ($allslides->slide_status == "4") {
                                            echo "selected";
                                        } ?>>Thursday
                                        </option>
                                        <option value="5" <?php if ($allslides->slide_status == "5") {
                                            echo "selected";
                                        } ?>>Friday
                                        </option>
                                        <option value="6" <?php if ($allslides->slide_status == "6") {
                                            echo "selected";
                                        } ?>>Saturday
                                        </option>
                                        <option value="7" <?php if ($allslides->slide_status == "7") {
                                            echo "selected";
                                        } ?>>Sunday
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select data-placeholder="Enable" class="form-control" name="slide_status">
                                        <option value="1" <?php if ($allslides->slide_status == "Yes") {
                                            echo "selected";
                                        } ?>>Enable
                                        </option>
                                        <option value="0" <?php if ($allslides->slide_status == "No") {
                                            echo "selected";
                                        } ?>>Disable
                                        </option>
                                    </select>
              ...
              <div class="col-md-4">
                <select data-placeholder="Select" class="form-control slideposition" id="slide_position_<?php echo $allslides->slide_id; ?>" name="slide_position" onchange="showminioptions(this.options[this.selectedIndex].value)">
                  <option value="main" <?php if ($allslides->slide_position == "main") {
                                echo "selected";
                            } ?>>Main Slider</option>
                  <option value="mini" <?php if ($allslides->slide_position == "mini") {
                                echo "selected";
                            } ?>>Mini Slider</option>
                </select>
              </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" placeholder="Slide Title Text"
                                           name="slide_title" value="<?php echo $allslides->slide_title_text; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Description</label>
                                <div class="col-md-8">
                                    <input class="form-control" type="text" placeholder="Slide Description Text"
                                           name="slide_desc" value="<?php echo $allslides->slide_desc_text; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Stars</label>
                                <div class="col-md-8">
                                    <input class="form-control" type="text" placeholder="Optional Slider Stars"
                                           name="slide_optional" value="<?php echo $allslides->slide_optional_text; ?>">
                                </div>
                            </div>
                            <div class="minislider">
                                <div class="form-group">
                                    <label class="col-md-3 control-label"> Link</label>
                                    <div class="col-md-8">
                                        <input class="form-control" type="text" placeholder="Slide Link"
                                               name="slide_link" value="<?php echo $allslides->slide_link; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Button Name</label>
                                    <div class="col-md-8">
                                        <input class="form-control" type="text" placeholder="Slide Button Text"
                                               name="slide_button" value="<?php echo $allslides->slide_link_name; ?>">
                                    </div>
                                </div>
                            </div>
                            <hr class="soften">
                            <div class="form-group">
                                <p class="mainres"><label class="col-md-8 control-label">Best Resolution 1024 x
                                        500 </label></p>
                                <p class="minires"><label class="col-md-8 control-label">Best Resolution 400 x
                                        400 </label></p>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Picture</label>
                                <div class="col-md-8">
                                    ...
                                    <p class="help-block">
                                        <?php if ($allslides->slide_position == "mini") {
                                            ?>
                                            <img src="<?php echo PT_SLIDER_IMAGES_THUMBS . $allslides->slide_image; ?>"
                                                 class="img-rounded preview_img" width="80" height="80" alt=""/>
                                            <?php
                                        } else {
                                            ?>
                                            <img src="<?php echo PT_SLIDER_IMAGES_THUMBS . $allslides->slide_image; ?>"
                                                 class="img-rounded preview_img" width="300" height="80" alt=""/>
                                            <?php
                                        }
                                        ?>
                                    </p>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="oldphoto"
                                           value="<?php echo $allslides->slide_image; ?>"/>
