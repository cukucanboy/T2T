...
<div class="modal-dialog modal-lg" style="z-index: 10">
    <div class="modal-content" style="z-index: 1025">
            ...
            <div class="center-block">
                ...
                <center>
                    ...
                    <?php if ($invoice->status == "unpaid") {
                        ...
                        <?php } else { ?>
                            <div class="btn btn-danger btn-lg btn-block text-center"><?php echo trans('0409'); ?> <b
                                        class="wow flash animted"><?php echo trans('0519'); ?></b></div>
                        <?php }
                    } elseif ($invoice->status == "reserved") { ?>

                        <!-- reserved -->
                        <b class="btn btn-success btn-lg btn-block wow flash animted"><?php echo trans('0445'); ?></b>
                        <br>
                        <!-- reserved -->
                    ...
                    <?php } else { ?>
                        ...
                        <!-- paid -->
                        <b class="btn btn-success btn-lg btn-block wow flash animted"><?php echo trans('081'); ?></b>
                        <br>
                        <p style="color:white"
                           class="text-center"><?php echo trans('0410'); ?><?php echo $invoice->accountEmail; ?></p>
                        <!-- paid -->
        ...
        <div style="min-height: 20px; padding: 5px; margin-bottom: 10px; background-color: rgba(179, 217, 238, 0.24); border-bottom: 1px solid #b3d9ee; border-top: 1px solid #b3d9ee; -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .05); box-shadow: inset 0 1px 1px rgba(0, 0, 0, .05);"
             class="">
            <div class="col-md-6">
                <h5 class="hidden-xs">
                ...
                <div class="hidden-xs"
                     style="font-size: 34px;text-transform:uppercase;font-weight: bold;"><?php echo trans('076'); ?></div>
                <div class="visible-xs"
                     style="font-size: 14px;text-transform:uppercase;font-weight: bold;"><?php echo trans('076'); ?></div>
                <div style="font-size: 12px;">
                    <strong><?php echo trans('076'); ?><?php echo trans('0434'); ?></strong> : <span
                            class="weak"> <?php echo $invoice->id; ?> </span>
                    <strong><?php echo trans('0398'); ?></strong> <?php echo $invoice->code; ?>
                </div>
            </div>
        ...
        <?php if ($invoice->status == "unpaid") {
            if (time() < $invoice->expiryUnixtime) { ?>
                ...
                <div class="form-group">
                    <center>
                        <?php if ($payOnArrival) { ?>
                            <button class="btn btn-default arrivalpay" data-module="<?php echo $invoice->module; ?>"
                                    id="<?php echo $invoice->id; ?>"><?php echo trans('0345'); ?></button>
                        <?php }
                        if ($singleGateway != "payonarrival") { ?>
                            <button data-toggle="modal" data-target="#paynow" type="submit"
                                    class="btn btn-primary"><?php echo trans('0117'); ?></button>
                        <?php } ?>
                    </center>
                </div>
                <hr class="hidden-xs">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div role="form">
                    <div class="form-group">
                        <label for="form-input" class="hidden-xs col-sm-2 control-label text-left"
                               style="padding: 10px;font-size: 18px;"><?php echo trans('0154'); ?></label>
                    ...
                    <div class="clearfix"></div>
                    <div class="col-sm-12 creditcardform" id="creditcardform" style="display:none;">
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="col-md-6  go-right">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" name="firstname"
                                                   ...
                                                   placeholder="<?php echo trans('0171'); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6  go-left">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" name="lastname"
                                                   id="card-holder-lastname" placeholder="<?php echo trans('0172'); ?>">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="col-md-12  go-right">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" name="cardnum" id="card-number"
                                                   placeholder="<?php echo trans('0316'); ?>"
                                    ...
                                    <div class="col-md-3 go-right">
                                        <div class="form-group ">
                                            <label style="font-size:13px"
                                                   class="required  go-right"><?php echo trans('0329'); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="bookingid" id="bookingid"
                                           value="<?php echo $invoice->bookingID; ?>"/>
                                    <input type="hidden" name="refno" id="bookingid"
                                           value="<?php echo $invoice->code; ?>"/>
									<input type="hidden" name="member" id="member"
                                           value="<?php echo $invoice->member; ?>"/>	                                       
                                    <button type="submit" class="btn btn-success btn-lg paynowbtn pull-left"
                                            onclick="return expcheck();"><?php echo trans('0117'); ?></button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
...
<script type="text/javascript">
    ...
    function expcheck() {
        ...
        if ($.trim(firstname) == "") {
            ...
            $(".submitresult").html("Card number, input number only").fadeIn("slow");
            return false;
        } else if (cardno.length < 16) {
            $(".submitresult").html("Invalid Card").fadeIn("slow");
            return false;
        } else if (month <= minMonth && year <= minYear) {
            $(".submitresult").html("Invalid Expiration Date").fadeIn("slow");
            return false;
        } else if ($.trim(cvv) == "") {
            $(".submitresult").html("Enter CVV").fadeIn("slow");
            return false;
        } else if (isNaN(cvv)) {
            $(".submitresult").html("Input CVV number only").fadeIn("slow");
            return false;
        } else if (cvv.length < 3) {
            $(".submitresult").html("Invalid CVV").fadeIn("slow");
            return false;
        } else if (cvv.length > 3) {
            $(".submitresult").html("Invalid CVV").fadeIn("slow");
            return false;
