                                ...
                                <div class="panel panel-default mb0">
                                    <div class="pad8">
                                        ...
                                        <div class="pad8 text-center">
                                            <h4>
                                                <strong><?php echo $currCode; ?><?php echo $todayPaid->totalPaidAmount + $todayExpedia->totalAmount; ?></strong>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="block">
                                <div class="panel panel-default mb0">
                                    <div class="pad8">
                                        ...
                                        <div class="pad8 text-center">
                                            <h4>
                                                <strong><?php echo $currCode; ?><?php echo $thirtyDaysPaid->totalPaidAmount + $thirtyDaysExpedia->totalAmount; ?></strong>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="block">
                                <div class="panel panel-default mb0">
                                    <div class="pad8">
                                        ...
                                        <div class="pad8 text-center">
                                            <h4>
                                                <strong><?php echo $currCode; ?><?php echo $nintyDaysPaid->totalPaidAmount + $nintyDaysExpedia->totalAmount; ?></strong>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="pad8 rev-bg">
                            <div class="col-md-5 row col-sm-5">
                                <div class="tempStatBox" style="margin-left:-10px;">
                                    <div class="tempStat"
                                         style="border-color: rgb(0, 204, 51);"><?php echo $today->totalCount + $todayExpedia->totalCount; ?></div>
                                </div>
                            </div>
                            <div class="col-lg-8 col-md-12 col-sm-7">
                                <div class="text-left">
                                    ...
                                    <p>Yesterday's
                                        : <?php echo $yesterday->totalCount + $yesterdayExpedia->totalCount; ?></p>
                                    <hr class="mtb04">
                    ...
                    <div class="block">
                        <div class="pad8 rev-bg">
                            <div class="col-md-5 row col-sm-5">
                                <div class="tempStatBox" style="margin-left:-10px;">
                                    <div class="tempStat"
                                         style="border-color: rgb(255, 153, 51);"><?php echo $thirtyDays->totalCount + $thirtyDaysExpedia->totalCount;; ?></div>
                                </div>
                            </div>
                            <div class="col-lg-8 col-md-12 col-sm-7">
                                <div class="text-left">
                                    ...
                                    <p>Last 60 Day's
                                        : <?php echo $sixtyDays->totalCount + $sixtyDaysExpedia->totalCount; ?></p>
                                    <hr class="mtb04">
                    ...
                    <div class="block hidden-md hiddin-sm hidden-xs">
                        <div class="pad8 rev-bg">
                            <div class="col-md-5 row col-sm-5">
                                <div class="tempStatBox" style="margin-left:-10px;">
                                    <div class="tempStat"
                                         style="border-color: rgb(204, 0, 51);"><?php echo $nintyDays->totalCount + $nintyDaysExpedia->totalCount; ?></div>
                                </div>
                            </div>
                            <div class="col-lg-8 col-md-12 col-sm-7">
                                <div class="text-left">
                                    ...
                                    <p>Last 180 Day's
                                        : <?php echo $oneEightyDays->totalCount + $oneEightyDaysExpedia->totalCount; ?></p>
                                    <hr class="mtb04">
...
<?php if (pt_permissions('booking', @$userloggedin)) { ?>
    ...
    <?php //echo modules::run($UriSegment . '/bookings/guestDashboardBookings'); ?>
<?php } ?>
<!--Recent Bookings -->
        ...
        <?php if (!empty($isadmin)) { ?>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="pull-left"><span class="fa fa-bar-chart-o"></span> Visit Statistics
                        of <?php echo date('F', time()); ?></div>
                    <div class="pull-right btn btn-xs btn-danger resetChart"><span class="fa fa-bar-chart-o"></span>
                        Reset Chart
                    </div>
                    <div class="clearfix"></div>
                </div>
            ...
            <form action="<?php echo base_url() . $this->uri->segment(1); ?>/quickbooking/" method="GET">
                ...
                <div class="modal-body form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select required name="service" data-placeholder="Select" class="form-control"
                                    id="servicetype" tabindex="1">
    ...
    $(function () {
        ...
        $('#resgraph').highcharts({
            ...
            xAxis: {
                ...
                categories: [<?php for ($day = 1; $day <= $totalDays; $day++) {
                    echo $day . ",";
                }?>]
            },
            yAxis: {
