...
$(function(){
  $(".posttitle").blur(function(){
    ...
    $.post("<?php echo base_url();?>admin/ajaxcalls/createDestinationsPermalink",{title: title, destinationid: destinationid},function(response){
  ...
  <?php $validationerrors = validation_errors();
    ...
    <br>
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-8">
              <div class="form-group ">
                <label class="required">Permalink : <?php echo base_url();?>/destination/</label> <br>
              ...
              <div class="panel panel-default">
                ...
                <div class="col-md-6">
                  <div class="form-group ">
                    ...
                    <input class="form-control postlatitude" type="text" placeholder="latitude" name="latitude" value="<?php echo  @$pdata[0]->latitude;?>">
                  </div>

                  <div class="form-group ">
                    <label class="required">Longitude</label>
                    <input class="form-control postlongitude" type="text" placeholder="longitude" name="longitude" value="<?php echo  @$pdata[0]->longitude;?>">
                  </div>
              <div class="form-group ">
      ...
      <input type="hidden" id="destinationid" name="destinationid" value="<?php echo @$pdata[0]->destination_id;?>" />
