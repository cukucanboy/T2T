 ...
 <?php if ($this->session->flashdata('flashmsgs')) {echo NOTIFY;}?>
  <div class="panel panel-primary">
    <div class="panel-heading">
      <span class="panel-title pull-left"><i class="fa fa-list-alt"></i> Translate Restaurant " <strong> <?php echo $transtitle;?></strong> "</span>
      ...
      <ul class="nav nav-tabs" style="height:850px;background-color:#F2F2F2;margin-top:5px;margin-bottom:0px">
        ...
        if (!empty ($language_list)) {
        		foreach ($language_list as $ldir => $lname) {
        				?>
        <li class="<?php if ($ldir == $lang) {echo "active";}?>"><a href="<?php echo base_url() . $adminsegment . "/restaurant/translate/" . $slug . "/" . $ldir;?>"><img src="<?php echo PT_LANGUAGE_IMAGES . $ldir . ".png";?>" style="width:30px;height:25px" alt="" /> <?php echo $lname;?></a></li>
        <?php }}?>
      </ul>
