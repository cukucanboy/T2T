    ...
    function searchForm($module = "hotels")
    {
        ...
        <div ng-controller="autoSuggestCtrl">
            ...
            if ($module == "flightsdohop") {
                ...
                <form action="//whitelabel.dohop.com/w/<?php echo $themeData->dohopusername; ?>/" method="GET"
                      target="_blank">
                    <div class="<?php echo $col2; ?>">
                        <div class="row">
                            ...
                            <input placeholder="<?php echo trans('0119'); ?>" required id="a1" name="a1" type="text"
                                   class="form input-lg RTL search-location sterm"
                                   placeholder="<?php echo trans('0273'); ?>" autocomplete="off" required/>
                    ...
                    <div class="<?php echo $col2; ?>">
                        <div class="row">
                            ...
                            <div class="clearfix"></div>
                            <i class="iconspane-lg icon_set_1_icon-41"></i>
                            <input placeholder="<?php echo trans('0120'); ?>" required id="a2" name="a2" type="text"
                                   class="form input-lg RTL search-location sterm"
                                   placeholder="<?php echo trans('0120'); ?>" autocomplete="off" required/>
                    ...
                    <div class="<?php echo $col2; ?>">
                        <div class="row">
                            ...
                            <input type="text" class="form input-lg go-text-left checkinsearch RTL dpfd1" name="d1"
                                   value="" placeholder="<?php echo trans('08'); ?>" required/>
                        </div>
                    </div>
                    <div class="<?php echo $col2; ?>">
                        <div class="row">
                            ...
                            <i class="iconspane-lg icon_set_1_icon-53"></i>
                            <input type="text"
                                   class="form input-lg returnDate mySelectCalendar checkinsearch RTL dpfd2 go-text-left"
                                   name="d2" value="" placeholder="<?php echo trans('08'); ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 col-xs-12">
                        <div class="row">
                            <label>&nbsp;</label>
                            <div class="clearfix"></div>
                            <button type="submit" value="<?php echo trans('012'); ?>"
                                    class="btn-primary btn btn-lg btn-block"><?php echo trans('012'); ?></button>
                        </div>
                    </div>
                </form>
                ...
                <form action="<?php echo base_url(); ?>car/" method="GET" target="_self">
                    <div class="<?php echo $col2; ?>">
                        <div class="row">
                            ...
                            <div class="clearfix"></div>
                            <i class="iconspane-lg icon_set_1_icon-41"></i>
                            <input required id="ct1" name="startlocation" type="text"
                                   class="form input-lg RTL ctlocation" placeholder="<?php echo trans('0210'); ?>"
                    ...
                    <div class="<?php echo $col2; ?>">
                        <div class="row">
                            ...
                            <div class="clearfix"></div>
                            <i class="iconspane-lg icon_set_1_icon-41"></i>
                            <input id="ct2" name="endlocation" type="text"
                                   class="searchInput form input-lg RTL ctlocation"
                                   placeholder="<?php echo trans('0211'); ?>" autocomplete="off"/>
                    ...
                    <div class="<?php echo $col2; ?> chkin">
                        <div class="row">
                            ...
                            <input type="text" class="form input-lg checkinsearch RTL icon-calendar dpcd1"
                                   name="pickupdate" value="<?php echo $themeData->ctcheckin; ?>"
                                   placeholder="<?php echo trans('08'); ?>" required/>
                        </div>
                    </div>
                    <div class="<?php echo $col1; ?>">
                        <div class="row">
                            ...
                            <div class="clearfix"></div>
                            <select style="padding-left:10px;" class="text-center input-lg form selectx"
                                    name="timeDepart">
                    ...
                    <div class="<?php echo $col2; ?> chkout" style="margin-bottom: -10px">
                        <div class="row">
                            ...
                            <div class="clearfix"></div>
                            <i class="iconspane-lg iconspane-lg icon_set_1_icon-53"></i>
                            <input type="text" class="form input-lg checkinsearch RTL icon-calendar dpcd2"
                                   name="dropoffdate" value="<?php echo $ctcheckout; ?>"
                                   placeholder="<?php echo trans('08'); ?>" required/>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 col-xs-12">
                        <div class="row">
                            <label>&nbsp;</label>
                            <div class="clearfix"></div>
                            <input type="submit" value="<?php echo trans('012'); ?>"
                ...
                <form autocomplete="off" action="<?php echo base_url() . $module; ?>/search" method="GET" role="search">
                    ...
                    <?php if ($module == "cars") { ?>
                        ...
                        <div class="<?php echo $col2; ?> xxl">
                            <div class="row">
                                <label class="hidden-xs go-right"><?php echo trans('0210'); ?></label>
                                <select name="pickupLocation" class="carsearch chosen-select RTL" id="carlocations"
                                        required>
                        ...
                        <div class="<?php echo $col2; ?> xxl">
                            <div class="row">
                                <label class="hidden-xs go-right"><?php echo trans('0211'); ?></label>
                                <select name="dropoffLocation" class="carsearch chosen-select RTL" id="carlocations2"
                                        required>
                        ...
                        <div class="<?php echo $col2; ?> chkin">
                            <div class="row">
                                ...
                                <div class="clearfix"></div>
                                <i class="iconspane-lg iconspane-lg icon_set_1_icon-53"></i>
                                <input type="text" class="form input-lg RTL" id="departcar" name="pickupDate"
                                       placeholder="<?php echo trans('08'); ?>"
                                       value="<?php echo $themeData->checkin; ?>" required>
                            </div>
                        </div>
                        <div class="<?php echo $col1; ?>">
                            <div class="row">
                                <label class="hidden-xs go-right"><?php echo trans('0259'); ?></label>
                                <div class="clearfix"></div>
                                <select style="padding-left:10px;" class="text-center input-lg form selectx car_tab"
                                        name="pickupTime">
                        ...
                        <div class="<?php echo $col2; ?> chkout">
                            <div class="row">
                                ...
                                <div class="clearfix"></div>
                                <i class="iconspane-lg iconspane-lg icon_set_1_icon-53"></i>
                                <input type="text" class="form input-lg RTL" id="returncar" name="dropoffDate"
                                       placeholder="<?php echo trans('08'); ?>"
                                       value="<?php echo $themeData->checkout; ?>" required>
                            </div>
                        </div>
                        <div class="<?php echo $col1; ?>">
                            <div class="row">
                    ...
                    <?php } else { ?>
                            ...
                            <?php if ($module == "ean") { ?>
                                ...
                                <script> $(function () {
                                        google.maps.event.addDomListener(window, "load", function () {
                                            new google.maps.places.Autocomplete(document.getElementById("HotelsPlacesEan"))
                                        });
                                    });
                                ...
                                <div class="<?php echo $col4; ?>">
                                    <div class="row">
                                        ...
                                        <div class="clearfix"></div>
                                        <i class="iconspane-lg icon_set_1_icon-41"></i>
                                        <input required id="citiesInput" name="city" type="text"
                                               class="form input-lg RTL" placeholder="<?php echo trans('026'); ?>"
                                               value="<?php echo @ $_GET['city']; ?>" required/>
                                    </div>
                                </div>
                                <!-- End EAN search input -->
                                <!-- Start Modal child ages -->
                                <div style="color:black" class="modal fade" id="ages" tabindex="1" role="dialog"
                                     aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title"
                                                    id="myModalLabel"><?php echo trans('011'); ?></h4>
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary"
                                                        data-dismiss="modal"><?php echo trans('0233'); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade" id="ages" tabindex="1" role="dialog" aria-hidden="true"
                            ...
                            <?php } else { ?>
                                ...
                                <div class="<?php echo $col4; ?>">
                                    <div class="row">
                                        ...
                                        <div class="clearfix"></div>
                                        <i class="iconspane-lg icon_set_1_icon-41"></i>
                                        <input type="text" name="txtSearch" ng-model="selected"
                                               placeholder="<?php if ($module == 'hotels') {
                                                   echo trans('026');
                                               } elseif ($module == 'tours') {
                                                   echo trans('0526');
                                               } ?>"
                                               uib-typeahead="result as result.name for result in getResults($viewValue,'<?php echo base_url(); ?>home/suggestions/<?php echo $module; ?>')"
                                               typeahead-loading="loadingLocations" typeahead-no-results="noResults"
                                               typeahead-popup-template-url="customTemplateResults.html"
                                               typeahead-on-select="onSelect($item, $model, $label)"
                                               typeahead-min-length='2' class="form input-lg">
                        ...
                        <div id="<?php if ($module == 'hotels') {
                            ...
                            echo 'tchkin';
                        } ?>" class="<?php echo $col2; ?> focusDateInput">
                            <div class="row">
                        ...
                        <?php if ($module == "hotels" || $module == "ean") { ?>
                            <div id="dpd2" class="<?php echo $col2; ?> focusDateInput">
                                <div class="row">
                                    ...
                                    <div class="clearfix"></div>
                                    <i class="iconspane-lg icon_set_1_icon-53"></i>
                                    <input type="text" placeholder="<?php echo trans('09'); ?>" name="checkout"
                                           class="form input-lg <?php if ($module == 'hotels') {
                                               echo 'dpd2';
                                           } elseif ($module == 'ean') {
                                               echo 'dpean2';
                                           } ?>" value="<?php if ($module == 'ean') {
                                        echo $themeData->eancheckout;
                                    } else {
                                        echo $themeData->checkout;
                                    } ?>" required>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($module == "hotels" || $module == "ean") { ?>
                            <div class="<?php echo $col1; ?>">
                                <div class="row">
                                    ...
                                    <select class="form selectx childcount" placeholder="<?php echo trans('011'); ?>"
                                            name="child" id="child">
                                        <?php for ($i = 0; $i <= 4; $i++) { ?>
                        ...
                        <?php }
                        if ($module == "ean") { ?>
                            <input type="hidden" name="childages" id="childages"
                                   value="<?php echo $themeData->childages; ?>">
                            <input type="hidden" name="search" value="search">
                        <?php } else { ?>
                            <input type="hidden" name="searching" value="{{searching}}"> <input type="hidden"
                                                                                                name="modType"
                                                                                                value="{{modType}}">
                        <?php }
                    } ?>
