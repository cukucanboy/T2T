...
!function (e) {
    "use strict";
    var t, n, i = 0, a = function () {
    };
    e.lazy = {
        init: function (n) {
            n = n || {}, t = n.delay || 0, a = n.callback || a, document.addEventListener ? (e.addEventListener("scroll", lazy.engine, !1), e.addEventListener("load", lazy.engine, !1)) : (e.attachEvent("onscroll", lazy.engine), e.attachEvent("onload", lazy.engine))
        }, engine: function () {
            n = setTimeout(function () {
                lazy.loadImage()
            }, t)
        }, loadImage: function () {
            for (var e = document.querySelectorAll("img[data-lazy]"), t = 0; t < e.length; t++)lazy.isVisible(e[t]) && (null !== e[t].getAttribute("data-lazy") && e[t].getAttribute("data-lazy") !== e[t].getAttribute("src") && (e[t].src = e[t].getAttribute("data-lazy"), i++), a(e[t]));
            e.length && i != e.length || lazy.releaseEvents()
        }, isVisible: function (e) {
            var t = e.getBoundingClientRect();
            return t.top >= 0 && t.left >= 0 && t.right < window.innerWidth && t.bottom < window.innerHeight
        }, releaseEvents: function () {
            document.removeEventListener ? e.removeEventListener("scroll", lazy.engine) : e.detachEvent("onscroll", lazy.engine), clearTimeout(n)
        }
    }
}(this);
lazy.init({
    delay: 1000, callback: function (elem) {
    }
});
...
var _iCheck = 'iCheck', _iCheckHelper = _iCheck + '-helper', _checkbox = 'checkbox', _radio = 'radio',
    _checked = 'checked', _unchecked = 'un' + _checked, _disabled = 'disabled', a
...
function on(input, state, keep) {
    var node = input[0], parent = input.parent(), checked = state == _checked, indeterminate = state == _indeterminate,
        disabled = state == _disabled, callback = indeterminate ? _determinate : checked ? _unchecked : 'enabled',
    ...
    if (node[state] !== !0) {
        ...
        if (indeterminate) {
            ...
            if (checked && node[_indeterminate]) {
                off(input, _indeterminate, !1)
            }
        }
        callbacks(input, checked, state, keep)
    }
    if (node[_disabled] && !!option(input, _cursor, !0)) {
...
var cb, optionSet1;
$(".checkbox").iCheck({checkboxClass: "icheckbox_square-grey", radioClass: "iradio_square-grey"});
$(".radio").iCheck({checkboxClass: "icheckbox_square-grey", radioClass: "iradio_square-grey"});
...
!function ($) {
    ...
    Slider.prototype = {
        constructor: Slider, over: !1, inDrag: !1, showTooltip: function () {
...
/* Go Top*/
$(".formSection").on("click", function () {
    $(".overlays").css({'display': 'block'});
    $(".formSection").css({'z-index': '8'});
    $('html, body').animate({scrollTop: $(".searcharea").offset().top - 120}, 1000);
    event.stopPropagation()
});
