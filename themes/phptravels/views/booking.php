<style>
    ...
    td {
        border-top: solid 1px rgba(231, 231, 231, 0.4);
    }
            ...
            <div class="modal-body">
                ...
                <div class="center-block">
                    <center>
                        ...
                        <h3 class="text-center"><?php echo trans('0409'); ?> <b
                                    class="text-success wow flash animted animated"><?php echo trans('0135'); ?></b>
                        </h3>
                        ...
                        <?php if (!empty($specialCheckInInstructions)) { ?>
                            <p><strong>Special Check-in Instructions</strong>
                                : <?php echo strip_tags($specialCheckInInstructions); ?></p>
                        <?php } ?>
            ...
            <div class="loadinvoice">
                            ...
                            <?php if ($appModule != "ean") { ?>
                                ...
                                <form id="bookingdetails" class="hidden-xs hidden-sm" action="" onsubmit="return false">
                                    ...
                                    <?php if ($appModule == "hotels") { ?>
                                        ...
                                        <input type="hidden" name="roomscount"
                                               value="<?php echo $room->roomscount; ?>"/>
                                        <input type="hidden" name="bedscount"
                                               value="<?php echo $room->extraBedsCount; ?>"/>
                                    ...
                                    <?php if ($appModule == "cars") { ?>
                                        <input type="hidden" name="pickuplocation"
                                               value="<?php echo $module->pickupLocation; ?>"/>
                                        <input type="hidden" name="dropofflocation"
                                               value="<?php echo $module->dropoffLocation; ?>"/>
                                        <input type="hidden" name="pickupDate"
                                               value="<?php echo $module->pickupDate; ?>"/>
                                        <input type="hidden" name="pickupTime"
                                               value="<?php echo $module->pickupTime; ?>"/>
                                        <input type="hidden" name="dropoffDate"
                                               value="<?php echo $module->dropoffDate; ?>"/>
                                        <input type="hidden" name="dropoffTime"
                                               value="<?php echo $module->dropoffTime; ?>"/>
                                        <input type="hidden" name="totalDays"
                                               value="<?php echo $module->totalDays; ?>"/>
                                    <?php } ?>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-6">
                                                            <label><?php echo trans('0522'); ?> <?php echo trans('0610'); ?></label>
                                                            <input type="" name="hotelname"
                                                                   class="form-control" placeholder="Hotel"/>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <label><?php echo trans('0522'); ?> <?php echo trans('0611'); ?></label>
                                                            <input type="text" class="form-control form-group tchkin"
                                                                   placeholder="Checkin Date" name="ctmcheckin"
                                                                   value="<?php echo $module->date; ?>">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <label><?php echo trans('0522'); ?> <?php echo trans('0612'); ?></label>
                                                            <input type="text" class="form-control form-group tchkin"
                                                                   placeholder="Checkout Date" name="ctmcheckout"
                                                                   value="<?php echo $module->date; ?>">
                                                        </div>
                                                    </div>
                                                    <!---->
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-action btn-lg btn-block completebook"
                                            name="<?php if (empty($usersession)) {
                                                echo "guest";
                                            } else {
                                                echo "logged";
                                            } ?>"
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form role="form" action="" method="POST">
                                            <div class="step">
                                                <div class="col-md-6  go-right">
                                                    <div class="form-group ">
                                                        ...
                                                        <input class="form-control" id="card-holder-firstname"
                                                               type="text" placeholder="<?php echo trans('0171'); ?>"
                                                               name="firstName"
                                                               value="<?php echo @$profile[0]->ai_first_name ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6  go-left">
                                                    <div class="form-group ">
                                                        <label class="required go-right"><?php echo trans('0172'); ?></label>
                                                        <input class="form-control" id="card-holder-lastname"
                                                               type="text" placeholder="<?php echo trans('0172'); ?>"
                                                               name="lastName"
                                                               value="<?php echo @$profile[0]->ai_last_name ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 go-right">
                                                    <div class="form-group ">
                                                        <label class="required  go-right"><?php echo trans('094'); ?></label>
                                                        <input class="form-control" id="card-holder-email" type="text"
                                                               placeholder="<?php echo trans('094'); ?>" name="email"
                                                               value="<?php echo @$profile[0]->accounts_email; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 go-right">
                                                    <div class="form-group ">
                                                        <label class="required go-right"><?php echo trans('0173'); ?></label>
                                                        <input class="form-control" id="card-holder-phone" type="text"
                                                               placeholder="<?php echo trans('0414'); ?>" name="phone"
                                                               value="<?php echo @$profile[0]->ai_mobile; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6  go-right">
                                                    <div class="form-group ">
                                                        <label class="required go-right"><?php echo trans('0105'); ?></label>
                                                        <select data-placeholder="Select" id="country" name="country"
                                                                class="form-control">
                                                ...
                                                <div class="col-md-6  go-left">
                                                    <div class="form-group ">
                                                        ...
                                                        <input id="card-holder-state" class="form-control" type="text"
                                                               placeholder="<?php echo trans('0101'); ?>"
                                                               name="province"
                                                               value="<?php if (!empty($profile[0]->ai_state)) {
                                                ...
                                                <div class="col-md-6 go-right">
                                                    <div class="form-group ">
                                                        ...
                                                        <input id="card-holder-city" class="form-control" type="text"
                                                               placeholder="<?php echo trans('0100'); ?>" name="city"
                                                               value="<?php echo @$profile[0]->ai_mobile; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 go-left">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="card-holder-postalcode" class="form-control"
                                                               type="text" placeholder="<?php echo trans('0104'); ?>"
                                                               name="postalcode"
                                                               value="<?php if (!empty($profile[0]->ai_postal_code)) {
                                                ...
                                                <div class="col-md-12  go-right">
                                                    <div class="form-group ">
                                                        ...
                                                        <textarea class="form-control"
                                                                  placeholder="<?php echo trans('098'); ?>" rows="4"
                                                                  name="address"><?php echo @$profile[0]->ai_address_1; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                            ...
                                            <input type="hidden" name="hotelname"
                                                   value="<?php echo $HotelSummary['name']; ?>"/>
                                            <input type="hidden" name="hotelstars" value="<?php echo $hotelStars; ?>"/>
                                            <input type="hidden" name="location"
                                                   value="<?php echo $HotelSummary['city']; ?>"/>
                                            <input type="hidden" name="thumbnail"
                                                   value="<?php echo $HotelImages['HotelImage'][0]['url']; ?>"/>
                                            <input type="hidden" name="roomname" value="<?php echo $roomname; ?>"/>
                                            <input type="hidden" name="roomtotal" value="<?php echo $roomtotal; ?>"/>
                                            <input type="hidden" name="checkin"
                                                   value="<?php echo $_GET['checkin']; ?>"/>
                                            <input type="hidden" name="checkout"
                                                   value="<?php echo $_GET['checkout']; ?>"/>
                                            <input type="hidden" name="roomtype"
                                                   value="<?php echo $_GET['roomtype']; ?>"/>
                                            <input type="hidden" name="ratecode"
                                                   value="<?php echo $_GET['ratecode']; ?>"/>
                                            <input type="hidden" name="currency" value="<?php echo $currency; ?>"/>
                                            <input type="hidden" name="affiliateConfirmationId"
                                                   value="<?php echo $eanlib->cid . $affiliateConfirmationId; ?>"/>
                                                ...
                                                <div class="col-md-6  go-left">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control" name="cardno"
                                                               id="card-number" pattern=".{12,}" required
                                                               title="12 characters minimum"
                                                               placeholder="Credit Card Number"
                                                               onkeypress="return isNumeric(event)"
                                                               value="<?php echo set_value('cardno'); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 go-left">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="cvv" id="cvv"
                                                               placeholder="<?php echo trans('0331'); ?>"
                                                               value="<?php echo set_value('cvv'); ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3 go-left">
                                                    <label class="required go-right">&nbsp;</label>
                                                    <img src="<?php echo base_url(); ?>assets/img/cc.png"
                  ...
                  <div class="col-md-6 go-right">
                    <div class="form-group ">
                      ...
                      <input class="form-control form" type="text" placeholder="<?php echo trans('098'); ?>" name="address"  value="<?php echo set_value('address'); ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <p style="padding:10px;"><input type="checkbox" name=""
                                                                                        id="policy" value="1">
                                                            <?php echo trans('0416'); ?> <br><br>
                                                            <a href="http://developer.ean.com/terms/en/" target="blank">Terms
                                                                and Conditions</a>
                                                        </p>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12">
                                                                <button type="submit"
                                                                        class="btn btn-success btn-lg btn-block paynowbtn"
                                                                        onclick="return expcheck();"
                                                                        name="<?php if (empty($usersession)) {
                                                                            echo "guest";
                                                                        } else {
                                                                            echo "logged";
                                                            ...
                                                            <div class="panel-body">
                                                                <p style="font-size:12px"
                                                                   class="go-right RTL"> <?php echo $checkInInstructions; ?></p>
                                                                <?php if (!empty($specialCheckInInstructions)) { ?>
                                                                    <p style="font-size:12px"
                                                                       class="go-right RTL"> <?php echo $specialCheckInInstructions; ?></p>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="col-md-4 go-left right-content">
                    <div class="bookingside">
                        <div class="filtertip">
                            <div class="padding20">
                                <h4 class="fs24 text-center"><i
                                            class="icon_set_1_icon-87 go-right"></i><span><?php echo trans('0411'); ?></span>
                                    <span class="countprice"></span></h4>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="hpadding30">
                            <div>
                                <div class="row">
                                    ...
                                    <img class="img-responsive" src="<?php echo $module->thumbnail; ?>"
                                         alt="<?php echo $module->title; ?>"/>
                                    <div style="margin-top:5px"
                                         class="size16 dark bold RTL go-right"><?php echo $module->title; ?></div>
                                    <div class="clearfix"></div>
                                    <div class="size13 grey RTL go-right"><i
                                                class="fa fa-map-marker RTL"></i> <?php echo $module->location; ?></div>
                                    <div class="clearfix"></div>
                                    <div style="margin-bottom:5px"
                                         class="go-right RTL"><?php echo $module->stars; ?></div>
                                </div>
                                    ...
                                    <?php if ($appModule == "hotels") { ?>
                                        <table style="margin-bottom:0px;" class="table table_summary">
                                            ...
                                            <tr class="beforeExtraspanel">
                                                ...
                                                <td class="text-right">
                                                    <?php echo $room->currCode; ?> <?php echo $room->currSymbol; ?><span
                                                            id="displaytax"><?php echo $module->taxAmount; ?></span>
                                                </td>
                                            </tr>
                                        ...
                                        <div style="margin-top: -30px;;padding-bottom:15px">
                                            <span class="pull-right lred2 bold fs30">  <strong><?php echo $room->currCode; ?> <?php echo $room->currSymbol; ?>
                                                    <span id="displaytotal"><?php echo $room->price; ?></span></strong></span>
                                            <div class="clearfix"></div>
                                        </div>
                                    <?php } ?>
                                        ...
                                        <table class="table table_summary">
                                            ...
                                            <div class="booking-deposit">
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <strong><span
                                                                    class="booking-deposit-font go-left"><?php echo $module->currCode; ?> <?php echo $module->currSymbol; ?>
                  ...
                  <?php echo $module->currCode; ?> <?php echo $module->currSymbol; ?><span
                                                        id="displaytotal"><?php echo $module->price; ?></span></span>
                                            <div class="clearfix"></div>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <div class="padding30" style="padding-top:0px">
                                        ...
                                        <br><span class="right"
                                                  style="font-size: 9px !important; color: #000 !important;"> (Including Taxes and Fees) </span>
                  ...
                  <?php }
                                        ...
                                        <?php if (!empty($hotelCharges)) { ?> <span class="left"
                   ...
                   <br><strong> Mandatory Taxes and Fees: </strong>
                            ...
                            <div class="row">
                                ...
                                <?php if (!empty($phone)) { ?>
                                    <div class="panel-body">
                                        <h4 class="opensans text-center"><i
                                                    class="icon_set_1_icon-57"></i><?php echo trans('061'); ?></h4>
