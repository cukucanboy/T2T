            ...
            <ul class="nav nav-tabs RTL tab_styling">
                <?php if (pt_main_module_available('hotels')) { ?>
                    <li role="presentation" class="active" data-title="HOTELS">
                        <a class="text-center" href="#HOTELS" data-toggle="tab" aria-controls="home"
                           aria-expanded="true">
                ...
                <?php if (pt_main_module_available('Travelstart')) { ?>
                    <li class="text-center"><a href="<?php echo base_url(); ?>flightst"><i
                                    class="searchicons icon_set_1_icon-28"></i>
                            <div class="visible-xs clearfix"></div><?php echo trans('Travelstart'); ?></a></li>
                <?php } ?>
    ...
    <div class="searchground">
        ...
        <div class="container formSection">
            <div class="tab-content">
                <?php if (pt_main_module_available('hotels')) { ?>
                    <!-- Hotels  -->
                    <div role="tabpanel" class="tab-pane fade active in <?php pt_searchbox('hotels'); ?>" id="HOTELS"
                ...
                <?php if (pt_main_module_available('ean')) { ?>
                    <!-- Expedia Hotels  -->
                    <div role="tabpanel" class="tab-pane fade <?php pt_searchbox('ean'); ?>" id="EXPEDIA"
                         aria-labelledby="home-tab">
                ...
                <?php if (pt_main_module_available('hotelscombined')) { ?>
                    <!-- HotelsCombine -->
                    <div role="tabpanel" class="tab-pane fade <?php pt_searchbox('hotelscombined'); ?>" id="HOTELSC"
                         aria-labelledby="home-tab">
                ...
                <?php if (pt_main_module_available('flightsdohop')) { ?>
                    <!-- Dohop Flights  -->
                    <div role="tabpanel" class="tab-pane fade <?php pt_searchbox('Flightsdohop'); ?>" id="DOHOP"
                         aria-labelledby="home-tab">
                ...
                <?php if (pt_main_module_available('wegoflights')) { ?>
                    <!-- Wego Flights  -->
                    <div role="tabpanel" class="tab-pane fade <?php pt_searchbox('Wegoflights'); ?>" id="WEGOFLIGHTS"
                         aria-labelledby="home-tab">
                ...
                <?php if (pt_main_module_available('tours')) { ?>
                    <!-- Tours  -->
                    <div role="tabpanel" class="tab-pane fade <?php pt_searchbox('tours'); ?>" id="TOURS"
                         aria-labelledby="home-tab">
                ...
                <?php if (pt_main_module_available('cars')) { ?>
                    <!-- Cars  -->
                    <div role="tabpanel" class="tab-pane fade <?php pt_searchbox('cars'); ?>" id="CARS"
                         aria-labelledby="home-tab">
                ...
                <?php if (pt_main_module_available('cartrawler')) { ?>
                    <!-- Cartrawler  -->
                    <div role="tabpanel" class="tab-pane fade <?php pt_searchbox('cartrawler'); ?>" id="CARTRAWLER"
                         aria-labelledby="home-tab">
                ...
                <div class="item <?php echo $ms->sactive; ?> hero" />
                    ...
                    <div class="container hidden-xs hidden-sm">
                        <div class="carousel-caption text-center">
                            <h5 data-wow-duration="1s" data-wow-delay="0.1s" style="font-size:32px;font-family: "
                                OpenSansLight", sans-serif;" class="fadeInUp wow"><?php echo $ms->title; ?></h5>
                            <div class="clearfix"></div>
                            <i class="slider-line"></i>
                            <p data-wow-duration="2s" data-wow-delay="0.1s" style="font-size:20px;font-family: "
                               OpenSansLight", sans-serif;" class="flash wow"><?php echo $ms->desc; ?></p>
                            <div class="clearfix"></div>
