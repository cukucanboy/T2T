...
<div class="bgwhite">
    <div class="container">
        ...
        <div class="row">
          ...
          <?php if(pt_main_module_available('destinations')){ ?>
          <div class="col-md-12 row5">
              <div class="form-group">
                  <h2 class="main-title go-right"><?php echo trans('Destination');?></h2>
                  <div class="clearfix"></div>
          ...
          <div class="col-md-3 row5">
              <a href="<?php echo $item->slug;?>">
                  <div class="featured">
                      ...
                      <div class="clearfix"></div>
                      <?php if($item->countItems > 0){ ?>
                      <div class="text-center featured-price">
                          <div class="text-center">
                              <small><?php echo $item->currCode;?></small> <?php echo $item->currSymbol; ?><?php echo $item->countItems;?>
                          </div>
                      </div>
                      <?php  } ?>
                      <div class="col-xs-12 go-right wow fadeIn featured-title">
                          <div class="p5">
                              <div class="strong"><i class="icon-location-6 go-right"></i> <?php echo character_limiter($item->title,25);?></div>
                          </div>
                      </div>
                  </div>
              </a>
          ...
          <?php } ?>
          <!-- End Destination List Module -->


          <!-- Start Advertising Module -->

          <?php if(pt_main_module_available('advertising')){ ?>
          <div class="col-md-12 row5">
              <div class="form-group">
                  <h2 class="main-title go-right"><?php echo trans('Advertising');?></h2>
                  <div class="clearfix"></div>
                  <i class="tiltle-line go-right"></i>
              </div>
          </div>
          <?php foreach($featuredAdvertising as $item){ ?>
          <div class="col-md-3 row5">
              <a href="<?php echo $item->slug;?>">
                  <div class="featured">
                      <div class="col-xs-12 go-right wow fadeIn">
                      ...
                      <div class="col-xs-12 go-right wow fadeIn featured-title">
                          <div class="p5">
                              <div class="strong"><?php echo character_limiter($item->title,25);?></div>
                                  <div class=""><i class="icon-location-6 go-right"></i> <?php echo character_limiter($item->destination,20);?></div>
                              <?php echo $item->stars;?>
